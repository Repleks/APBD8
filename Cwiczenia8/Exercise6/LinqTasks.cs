...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = (from emp in Emps
                select new { emp.Ename, emp.Job, emp.HireDate }).Union(
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = from emp in Emps
                ...
                select new
                {
                    name = (from dept in Depts
                        where dept.Deptno == g.Key
                        select dept.Dname).FirstOrDefault(),
